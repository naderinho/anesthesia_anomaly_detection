...
#'Primus/PAMB_MBAR',         # Ambient pressure                                      N       mbar
...
#'Primus/SET_AGE',           # Patient age                                           N       years
#'Primus/SET_FIO2',          # Set fraction of inspired O2                           N       %
#'Primus/SET_FLOW_TRIG',     # Set flow trigger value                                N       mL/min
#'Primus/SET_FRESH_FLOW',    # Set fresh gas flow                                    N       mL/min
#'Primus/SET_INSP_PAUSE',    # Set inspiratory pause                                 N       %
#'Primus/SET_INSP_PRES',     # Set inspiratory pressure                              N       mbar
#'Primus/SET_INSP_TM',       # Set inspiratory time                                  N       sec
#'Primus/SET_INTER_PEEP',    # Set positive end expiratory pressure (PEEP)           N       mbar
#'Primus/SET_PIP',           # Set peak inspiratory pressure                         N       mbar
#'Primus/SET_RR_IPPV',       # Set respiratory rate                                  N       /min
#'Primus/SET_TV_L',          # Set tidal volume in liter                             N       L
'Primus/TV',                # Tidal volume                                          N       mL
#'Primus/VENT_LEAK',         # Ventilator leakage                                    N       mL/min
#'Orchestra/AMD_RATE',       # Infusion rate (amiodarone 2 mg/mL)                    N       mL/hr
#'Orchestra/AMD_VOL',        # Infused volume (amiodarone 2 mg/mL)                   N       mL
#'Orchestra/DEX2_RATE',      # Infusion rate (dexmedetomidine 2 mcg/mL)              N       mL/hr
#'Orchestra/DEX2_VOL',       # Infused volume (dexmedetomidine 2 mcg/mL)             N       mL
#'Orchestra/DEX4_RATE',      # Infusion rate (dexmedetomidine 4 mcg/mL)              N       mL/hr
#'Orchestra/DEX4_VOL',       # Infused volume (dexmedetomidine 4 mcg/mL)             N       mL
#'Orchestra/DOBU_RATE',      # Infusion rate (dobutamine 2 mg/mL)                    N       mL/hr
#'Orchestra/DOBU_VOL',       # Infused volume (dobutamine 2 mg/mL)                   N       mL
#'Orchestra/DOPA_RATE',      # Infusion rate (dopamine 2 mg/mL)                      N       mL/hr
#'Orchestra/DOPA_VOL',       # Infused volume (dopamine 2 mg/mL)                     N       mL
#'Orchestra/DTZ_RATE',       # Infusion rate (diltiazem 1 mg/mL)                     N       mL/hr
#'Orchestra/DTZ_VOL',        # Infused volume (diltiazem 1 mg/mL)                    N       mL
#'Orchestra/EPI_RATE',       # Infusion rate (epinephrine 20 mcg/mL)                 N       mL/hr
#'Orchestra/EPI_VOL',        # Infused volume (epinephrine 20 mcg/mL)                N       mL
#'Orchestra/FUT_RATE',       # Infusion rate (futhan 0.5 mg/mL)                      N       mL/hr
#'Orchestra/FUT_VOL',        # Infused volume (futhan 0.5 mg/mL)                     N       mL
#'Orchestra/MRN_RATE',       # Infusion rate (milrinone 200 mcg/mL)                  N       mL/hr
#'Orchestra/MRN_VOL',        # Infused volume (milrinone 200 mcg/mL)                 N       mL
#'Orchestra/NEPI_RATE',      # Infusion rate (norepinephrine 20 mcg/mL)              N       mL/hr
#'Orchestra/NEPI_VOL',       # Infused volume (norepinephrine 20 mcg/mL)             N       mL
#'Orchestra/NPS_RATE',       # Infused rate (nitroprusside 0.2 mg/mL)                N       mL/hr
#'Orchestra/NPS_VOL',        # Infusion volume (nitroprusside 0.2 mg/mL)             N       mL
#'Orchestra/NTG_RATE',       # Infused rate (nitroglycerin 0.2 mg/mL)                N       mL/hr
#'Orchestra/NTG_VOL',        # Infusion volume (nitroglycerin 0.2 mg/mL)             N       mL
#'Orchestra/OXY_RATE',       # Infused rate (oxytocin 0.2 U/mL)                      N       mL/hr
#'Orchestra/OXY_VOL',        # Infusion volume (oxytocin 0.2 U/mL)                   N       mL
#'Orchestra/PGE1_RATE',      # Infused rate (prostaglandin-E1 2 mg/mL)               N       mL/hr
#'Orchestra/PGE1_VOL',       # Infusion volume (prostaglandin-E1 2 mg/mL)            N       mL
#'Orchestra/PHEN_RATE',      # Infused rate (phenylephrine 100 mcg/mL)               N       mL/hr
#'Orchestra/PHEN_VOL',       # Infusion volume (phenylephrine 100 mcg/mL)            N       mL
...
#'Orchestra/RFTN50_CE',      # Effect-site concentration (remifentanil 50 mcg/mL)    N       ng/mL
#'Orchestra/RFTN50_CP',      # Plasma concentration (remifentanil 50 mcg/mL)         N       ng/mL
#'Orchestra/RFTN50_CT',      # Target concentration (remifentanil 50 mcg/mL)         N       ng/mL
#'Orchestra/RFTN50_RATE',    # Infusion rate (remifentanil 50 mcg/mL)                N       mL/hr
#'Orchestra/RFTN50_VOL',     # Infused volume (remifentanil 50 mcg/mL)               N       mL
#'Orchestra/ROC_RATE',       # Infusion rate (rocuronium 2 mg/mL)                    N       mL/hr
#'Orchestra/ROC_VOL',        # Infused volume (rocuronium 2 mg/mL)                   N       mL
#'Orchestra/VASO_RATE',      # Infusion rate (vasopressin 0.2 U/mL)                  N       mL/hr
#'Orchestra/VASO_VOL',       # Infused volume (vasopressin 0.2 U/mL)                 N       mL
#'Orchestra/VEC_RATE',       # Infusion rate (vecuronium 1 mg/mL)                    N       mL/hr
